...
from gui_frames.controll_buttons import controll_frame
...
class gui(tkinter.Tk):
    def __init__(self):
        ...
        Control_frame = controll_frame(self)

        State_frame.grid(column=0, row=0, padx=5, pady=5)
        Set_state_frame.grid(column=0, row=1, padx=5, pady=5, ipadx=2)
        Serial_frame.grid(column=1, row=0, padx=5, pady=5, ipadx=2)
        Control_frame.grid(column=1, row=1, padx=4, pady=5, ipadx=5, ipady=5)
